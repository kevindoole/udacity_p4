...
class TestSessionService(ServiceTestCase):
    def test_it_can_create_sessions(self):
        ...
        conf_id = Conference(name="a conference", organizerUserId='kdoole@gmail.com', parent=p_key).put().urlsafe()
    ...
    def test_only_owners_can_create_sessions(self):
        ...
        auth = Auth()
        auth.getUserId = MagicMock(return_value=unicode('not.an.owner@hacker.com'))
